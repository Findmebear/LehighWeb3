            ...
            <div class = 'container'>
                            ...
                            <div class = "row align-items-center">
                                ...
                                <div class = 'col-lg-6 px-xl-10'>
                                    ...
                                    <ul class = 'listed-unstyled mb-1-9'>
                                        <li class = 'mb-2 mb-xl-3 display-28'><span class= 'display-26 text-secondary me-2 font-weight-600'>Wallet Address: </span> sample address</li>
                                        <li class = 'mb-2 mb-xl-3 display-28'><span class= 'display-26 text-secondary me-2 font-weight-600'>Email: </span> sample email</li>
                                    </ul>
                ...
                <div class = 'col-lg-12 mb-4 mb-sm-5'>
                    <div>
                        ...
                        <p class = 'text-primary'> Add a bio...</p>
                    </div>
                </div>
            </div>
        </section>
